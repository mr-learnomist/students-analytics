...
import { TeacherReportsTab }     from './tabs/teacherReportsTab.js';
import { AttendanceReportsTab }  from './tabs/attendanceReportsTab.js';
...
const TABS = [
  ...
  { id: 'teachers',    label: 'Teachers',          icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>', module: TeacherReportsTab },
  { id: 'attendance',  label: 'Attendance',         icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>', module: AttendanceReportsTab },
